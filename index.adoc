...
- Co-Designed and implemented https://github.com/mhewedy/spring-data-jpa-mongodb-expressions[spring-data-jpa-mongodb-expressions,role=external,window=_blank] a library that converts MongoDB queries into SQL queries. +
