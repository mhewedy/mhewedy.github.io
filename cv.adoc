...
=== Technical Leader and Solutions Architect
...
https://github.com/castlemock/castlemock/pulls?q=is%3Apr+author%3Amhewedy[`Castlemock`,role=external,window=_blank], https://github.com/tair-opensource/RedisShake/pulls?q=is%3Apr+author%3Amhewedy[`RedisShake`,role=external,window=_blank],
